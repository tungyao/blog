...
<div style="margin: 0;padding: 1rem 0 0 0;height: 12rem;width: 100%;display: flex;justify-content: space-between;flex-direction: row">
       ...
       <a href="https://mosaicjs.site" style="margin:1rem;width: 5rem;height: 5rem;display: flex;justify-content: center;align-items: center">
              <img src="https://mosaicjs.site/MosaicLogo.50cf5e0e.png" alt="" width="100%" >
</a>
       <a href="https://golang.google.cn" style="margin:1rem;width: 5rem;height: 5rem;display: flex;justify-content: center;align-items: center">
       ...
       <a href="http://lesscss.cn" style="margin:1rem;width: 5rem;height: 5rem;display: flex;justify-content: center;align-items: center">
       <img src="http://s.nodejs.cn/less/img/logo.png" alt="" width="100%">
</a>
       <a href="https://redis.io" style="margin:1rem;width: 5rem;height: 5rem;display: flex;justify-content: center;align-items: center" >
       <img src="https://redis.io/images/redis.png" alt="" width="100%" >
</a>
       <a href="https://www.mysql.com/" style="margin:1rem;width: 5rem;height: 5rem;display: flex;justify-content: center;align-items: center">
